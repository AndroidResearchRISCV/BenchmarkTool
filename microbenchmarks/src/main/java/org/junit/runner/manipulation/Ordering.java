...
public abstract class Ordering {
    ...
    public static Ordering definedBy(
            Class<? extends Factory> factoryClass, Description annotatedTestClass)
        ...
        Factory factory;
        try {
            Constructor<? extends Factory> constructor = factoryClass.getConstructor();
     ...
     */
    public static Ordering definedBy(
            Factory factory, Description annotatedTestClass)
            throws InvalidOrderingException {
        if (factory == null) {
