...
/**
 * If you allocate expensive external resources in a {@link BeforeClass} method you need to release them
 ...
 * methods are guaranteed to run even if a {@link BeforeClass} method throws an
